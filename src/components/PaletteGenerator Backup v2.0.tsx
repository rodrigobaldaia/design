...
Goal: typical colors of ${goal}`;
  ...
  return (
    <VStack maxW="100%" w="100%" pt={6} align={"left"}>
      ...
      <VStack p={12} borderRadius="lg" borderWidth={"2px"} borderColor={"gray.300"} w="100%" bg={"gray.50"}>
        {!started ? (
          <>
          ...
          <>
            ...
            {palette.length > 0 && (
              <VStack w="100%" align="start">
                ...
                {/* Color rectangles */}
                <Flex w="100%" overflow="hidden" borderRadius="md" h="580px" mt={4} mb={8} border={"2px solid #e6e6e6ff"}>
                  {palette.map((color, i) => (
                    <Box
                      key={`${color}-${i}`}
                      flex="1"
                      ...
                      >
                        ...
                        {locked[i] ? (
                          <IconButton
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              toggleFavorite(i); // sets locked[i] = false
                            }}
                          >
                            <MdLockOpen />
                          </IconButton>
                          ...
                          <IconButton
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              toggleFavorite(i); // sets locked[i] = true
                            }}
                          >
                            <MdLock />
                          </IconButton>
